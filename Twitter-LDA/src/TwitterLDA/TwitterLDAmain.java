...
public class TwitterLDAmain {
	...
	public static void main(String args[]) throws Exception {
		...
		String filelist = base + "/files/" + mon + "_files.txt";
		// String dataDir = base + "/Data4Model/" + name + "/";
		// String outputDir = base + "/ModelRes/" + name + "/";
		String dataDir = base + "/Data4Model/" + name + "/"+mon+"/";
		String outputDir = base + "/ModelRes/" + name + "/"+mon+"/";
		String modelParas = base + "/modelParameters-" + name+ "_" + mon + ".txt";
